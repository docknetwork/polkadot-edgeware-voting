  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_12__["default"])(SubstrateService, [{
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              this.keyring = keyring; // Create the API and wait until ready
    ...
    value: function getAccount() {
      if (this.keyring) {
        ...
        var alice = this.keyring.addFromUri('//Alice', {
          name: 'Alice'
        }); // dev only, of course

        console.log('pairs', this.keyring.getPairs());
        console.log("".concat(alice.meta.name, ": has address ").concat(alice.address, " with publicKey [").concat(alice.publicKey, "]"));
        return alice;
      }
    }
  }, {
...
//# sourceMappingURL=index.js.8772f56f9f930fcb63a6.hot-update.js.map