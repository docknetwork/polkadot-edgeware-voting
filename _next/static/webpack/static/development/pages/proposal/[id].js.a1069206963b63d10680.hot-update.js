...
var Proposal = function Proposal() {
  ...
  function loadProposal() {
    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.async(function loadProposal$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.awrap(_services_substrate__WEBPACK_IMPORTED_MODULE_21__["default"].getProposal(hash));

          case 2:
            data = _context.sent;
            setProposal(data.toJSON());
            _context.next = 6;
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.awrap(_services_substrate__WEBPACK_IMPORTED_MODULE_21__["default"].getVoteRecords(data.toJSON().vote_id));
  ...
  function hexToAscii(str) {
    ...
    for (var n = 0; n < hex.length; n += 2) {
      var intInput = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(hex.substr(n, 2), 16);
  ...
  if (proposal) {
    return __jsx(react__WEBPACK_IMPORTED_MODULE_4___default.a.Fragment, null, __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_7__["default"], {
      variant: "h4",
      __source: {
      ...
      __self: this
    }, "Hash: ", hash), voteRecords && __jsx(react__WEBPACK_IMPORTED_MODULE_4___default.a.Fragment, null, __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_7__["default"], {
      variant: "h6",
      color: "textSecondary",
      gutterBottom: true,
      __source: {
      ...
      __self: this
    }, "Author: ", proposal.author), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_7__["default"], {
      variant: "h6",
      color: "textSecondary",
      gutterBottom: true,
      __source: {
      ...
      __self: this
    }, "Commitments: ", voteRecords ? voteRecords.commitments.length : 0), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_7__["default"], {
      variant: "h6",
      color: "textSecondary",
      gutterBottom: true,
      __source: {
      ...
      __self: this
    }, "Reveals: ", voteRecords ? voteRecords.reveals.length : 0), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_7__["default"], {
      variant: "h6",
      color: "textSecondary",
      gutterBottom: true,
      __source: {
      ...
      __self: this
    }, "Stage: ", _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(voteRecords.data.stage)[0]), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_7__["default"], {
      variant: "h6",
      color: "textSecondary",
      gutterBottom: true,
      __source: {
      ...
      __self: this
    }, "Vote Type: ", voteRecords.data.vote_type.binary === null ? 'Binary' : 'MultiOption'), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_7__["default"], {
      variant: "h6",
      color: "textSecondary",
      gutterBottom: true,
      __source: {
      ...
      __self: this
    }, "Tally Type: ", voteRecords.data.tally_type.oneperson === null ? 'OnePerson' : 'OneCoin'), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_7__["default"], {
      variant: "h6",
      color: "textSecondary",
      __source: {
        fileName: _jsxFileName,
      ...
      __self: this
    }, __jsx(_material_ui_core_FormLabel__WEBPACK_IMPORTED_MODULE_14__["default"], {
      component: "legend",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 130
      ...
      __self: this
    }, "Votes"), __jsx(_material_ui_core_RadioGroup__WEBPACK_IMPORTED_MODULE_11__["default"], {
      "aria-label": "vote",
      name: "vote",
      value: vote,
      ...
      return __jsx(_material_ui_core_FormControlLabel__WEBPACK_IMPORTED_MODULE_12__["default"], {
        key: index,
        value: outcome,
    ...
    }))), _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(voteRecords.data.stage)[0] === 'voting' && __jsx(react__WEBPACK_IMPORTED_MODULE_4___default.a.Fragment, null, __jsx("br", {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 140
      },
      ...
      __self: this
    }), voteRecords && __jsx(_material_ui_core_Card__WEBPACK_IMPORTED_MODULE_8__["default"], {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 158
      },
      ...
      component: _material_ui_core_CardContent__WEBPACK_IMPORTED_MODULE_9__["default"],
      __source: {
        fileName: _jsxFileName,
        lineNumber: 159
      },
      ...
      __self: this
    }, "Voter Address"), __jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_17__["default"], {
      align: "right",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 164
      ...
      __self: this
    }, "Voted For"))), __jsx(_material_ui_core_TableBody__WEBPACK_IMPORTED_MODULE_16__["default"], {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 167
      },
      ...
      return __jsx(_material_ui_core_TableRow__WEBPACK_IMPORTED_MODULE_20__["default"], {
        ...
        __self: this
      }, row[0]), __jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_17__["default"], {
        align: "right",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 173
        ...
        __self: this
      }, _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(row[1])));
    }))))));
  } else {
...
//# sourceMappingURL=[id].js.a1069206963b63d10680.hot-update.js.map